...
if __name__=="__main__":
    ...
    times,voltages_in,voltages_out,freqs,resistance=load_freqsweep('/home/thouin/Documents/Repo/colberto/HDPE_piezo_sandwhich_14_53_impedance_measurement.h5')
    impedances=extract_impedances(times,voltages_in,voltages_out,freqs,resistance)
    plt.semilogx(freqs,np.real(impedances),label='real, HDPE/piezo/HDPE')
   # #plt.semilogx(freqs,np.imag(impedances),label='imag_beforetight')
    times,voltages_in,voltages_out,freqs,resistance=load_freqsweep('/home/thouin/Documents/Repo/colberto/piezo_sanwhich_3mm_3mm_18_26_impedance_measurement.h5')
    impedances=extract_impedances(times,voltages_in,voltages_out,freqs,resistance)
    plt.semilogx(freqs,np.real(impedances),label='real, 3mm/piezo/3mm')
