...
class LOmeasurementPlot(QtWidgets.QMainWindow):
    ...
    def __init__(self, plotWidget, *args, **kwargs):
        ...
        '''
        super(LOmeasurementPlot, self).__init__(*args, **kwargs)
        ...
        self.graphWidget.setLabel('left', 'Intensity [cts]', **self.styles)
...
class MDCSmeasurementPlot(QtWidgets.QMainWindow):
    ...
    def __init__(self, graphLayoutWidget, *args, **kwargs):
        ...
        '''
        super(MDCSmeasurementPlot, self).__init__(*args, **kwargs)
        ...
        self.plot.setLabel('left', 'Delay [fs]', **self.styles)
        self.plot.setLabel('bottom', 'Wavelength [nm]', **self.styles) 
...
class MDCSmeasurementFourierPlot(QtWidgets.QMainWindow):
    ...
    def __init__(self, graphLayoutWidget, *args, **kwargs):
        '''
            Initializes the graph to diplay the vertical calibration data.
                - imageItem: (pyqtgraph.ImageItem) the image Item where the 2D data will be plotted
        '''
        super(MDCSmeasurementFourierPlot, self).__init__(*args, **kwargs)
        ...
        self.plot.getAxis('left').setStyle(tickFont=self.fontForTickValues)
        self.plot.getAxis('bottom').setStyle(tickFont=self.fontForTickValues)
        self.plot.setLabel('left', 'Absorption [eV]', **self.styles)
        self.plot.setLabel('bottom', 'Emission [eV]', **self.styles) 
